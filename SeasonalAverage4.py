...
# ------------------------------------------------------------------------------------------------ #
def CalculateYearsMonthsDays(dateKey):
...
includeMaskedPointsAsZeroInAverage=False, months=['04', '05', '06', '07', '08', '09']):
    ...
    while k < len(keysToAverage):
        ...
        year, month, day = CalculateYearsMonthsDays(key)
...
monthsWithoutMaskedPoints, globallyAveragedEfficienciesWithoutMaskedPointsSummerNorthernHemisphere = \
SpatiallyAverageEfficiencyData(efficiencyDict, keysToAverage, startYear, startMonth, startDay, \
includeMaskedPointsAsZeroInAverage=False, \
latitudeLimits=[89.875, -89.875], longitudeLimits=[-179.875, 179.875], \
